...
public class LinkedList {
    ...
    public void deleteAtLast(){
        ...
        if(this.size == 1){
            ...
            lastpreviousNode.next.pre=null;
    ...
    public void printElementFromEnd(){
        Node temp = tail;
    ...
    //Recursive Insertion at Index

    public void InsertRecursively(int val, int pos){
        InsertRecursively( val, pos,head,0);
    }

    public Node InsertRecursively(int val, int pos,Node temp,int n){
        ...
        temp = InsertRecursively(val,pos,temp.next,n+1);
